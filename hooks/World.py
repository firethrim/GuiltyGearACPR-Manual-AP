...
def after_create_regions(world: World, multiworld: MultiWorld, player: int):
    ...
    arcade_clears_goal = get_option_value(multiworld, player, "characters_to_win")

    for victory_name in victory_names:
        if victory_name in location_name_to_location:
            location_name_to_location[victory_name]["requires"] = \
                f"|@Character Completed:{int(arcade_clears_goal)}|"
